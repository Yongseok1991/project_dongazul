...
public class EchoHandler extends TextWebSocketHandler{
    ...
    public void afterConnectionEstablished(
		...
		session.sendMessage(new TextMessage("CONNECTION ESTABLSHED[id: " + session.getId() + "]"));
    ...
    protected void handleTextMessage(
    	...
    	// 싱글톤객체만들고 자료구조 웹소켓세션아이디 값으로 웹소켓세션객체를 넣어주고 
    	// email id도 함께 적용
    	// a - b 
        ...
        for(WebSocketSession sess : sessions){
            ...
            sess.sendMessage(new TextMessage(profile.getNickname()+" : "+message.getPayload()));
